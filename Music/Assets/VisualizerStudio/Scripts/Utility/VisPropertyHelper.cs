...
public enum LightProperty
{
    ...
    SpotAngle,
    ShadowBias,
#if (UNITY_2_6 || UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6)
    ShadowSoftness,
    ShadowSoftnessFade,
#else
...
{		
    ...
    public static void SetGameObjectProperty(GameObject gameObject, GameObjectProperty targetProperty, float propertyValue)
	{
        ...
        Rigidbody rigidbodyComp = gameObject.GetComponent<Rigidbody>();
        ...
        switch (targetProperty)
        {
            ...
            case GameObjectProperty.XVelocity:
                if (rigidbodyComp != null)
                    rigidbodyComp.velocity = new Vector3(propertyValue, 
							                                 	rigidbodyComp.velocity.y, 
							                                 	rigidbodyComp.velocity.z);
            ...
            case GameObjectProperty.YVelocity:
                if (rigidbodyComp != null)
                    rigidbodyComp.velocity = new Vector3(rigidbodyComp.velocity.x, 
							                                 	propertyValue, 
							                                 	rigidbodyComp.velocity.z);
				else if (gameObject.transform !=  null)
            ...
            case GameObjectProperty.XAngularVelocity:
                if (rigidbodyComp != null)
                    rigidbodyComp.angularVelocity = new Vector3(propertyValue, 
							                                           rigidbodyComp.angularVelocity.y, 
							                                           rigidbodyComp.angularVelocity.z);
				else if (gameObject.transform != null)
					gameObject.transform.Rotate(propertyValue * Time.deltaTime, 0.0f, 0.0f);
                break;
            case GameObjectProperty.YAngularVelocity:
                if (rigidbodyComp != null)
                    rigidbodyComp.angularVelocity = new Vector3(rigidbodyComp.angularVelocity.x, 
							                                        	propertyValue, 
							                                        	rigidbodyComp.angularVelocity.z);
				else if (gameObject.transform != null)
